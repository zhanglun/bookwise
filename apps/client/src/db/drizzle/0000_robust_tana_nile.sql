...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "book_blobs" (
	"book_uuid" uuid,
	"blob_uuid" uuid
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "book_blobs" ADD CONSTRAINT "book_blobs_book_uuid_books_uuid_fk" FOREIGN KEY ("book_uuid") REFERENCES "public"."books"("uuid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "book_blobs" ADD CONSTRAINT "book_blobs_blob_uuid_blobs_uuid_fk" FOREIGN KEY ("blob_uuid") REFERENCES "public"."blobs"("uuid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
