...
export const epubHandler: FileHandler = {
...
export async function fileReaderAsync(file: File) {
...
export async function parseCover(cover: string, blob: Blob): Promise<string | null> {
